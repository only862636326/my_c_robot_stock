...
解速度单位为 弧度 / s
*******/
#define RPM_RATION           2292.21318f  //当轮速度为1 mm/s 时的rpm  
                                          //1 / (pi * 2 * r) * (60 * 19) * 1000
#define STREER_DIR_RATION    25486.22222f //舵轮方向转一度的position 8192*80*14/360
#define OMEGA_RATION  

#define MAX_AXIS_SPEED        1000.0f  //(mm / s)
#define ACC_AXIS              200.0f   //(mm / s^2)
#define MAX_OMAGA_SPEED       10.0f    // d/s             
#define ACC_OMAGA             5        // d/s^2
